...
\subsubsection{DenseNet-121 on CIFAR-100}
...
\subsubsection{Reduced Precision and Bandlimited Training}
In Figure~\ref{fig:micro-mem}
 ...
 \begin{figure}[t]
  \includegraphics[width=0.95\linewidth]{fp32_fp16_fft50-2.pdf} %width=\linewidth]
...
\subsubsection{Resource Usage vs Accuracy} 
...
% For ResNet-50 on ImageNet, we observe a subsubstantial drop in memory usage after applying our compression and similar behavior in terms of the time per epoch to the ResNet-18 model on CIFAR-10.
...
\subsubsection{Dynamic Changes of Compression}
...
\subsubsection{Compression Based on Preserved Energy}
...
\subsubsection{Visualization of the Compression in 1D}
...
\subsubsection{Energy Based Compression for ResNet-18}
...
\subsubsection{Training vs. Inference Bandlimiting}
...
\subsubsection{Error Incurred by 2D Convolution with Compression}
...
% \subsubsection{Shapes of filters, activations and gradients in the frequency domain.}
...
\subsubsection{Robustness to Adversarial Examples}
